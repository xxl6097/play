...
public class LibVlcUtil {
    public final static String TAG = "MEDIA/LibMEDIA/Util";
...
//    }
    ...
    public static boolean hasCompatibleCPU(Context context)
    {
        ...
        String ppp=context.getApplicationInfo().dataDir;
        ElfData elf = readLib(context.getApplicationInfo().dataDir + "/lib/libvlcjni.so");
        if(elf == null) {
            Log.e(TAG, "WARNING: Unable to read libmediajni.so; cannot check device ABI!");
