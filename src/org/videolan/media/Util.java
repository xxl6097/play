...
public class Util {
    public final static String TAG = "MEDIA/Util";
//    private final static boolean hasNavBar;
    /** A set of utility functions for the MEDIA application */
...
//        hasNavBar = isICSOrLater() && !devicesWithoutNavBar.contains(android.os.Build.MODEL);
    ...
    public static LibVLC getLibMediaInstance() throws LibMediaException {
        LibVLC instance = LibVLC.getExistingInstance();
        if (instance == null) {
            Thread.setDefaultUncaughtExceptionHandler(new MediaCrashHandler());

            instance = LibVLC.getInstance();
            Context context = MEDIAApplication.getAppContext();
            SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
            updateLibMediaSettings(pref);
    ...
    public static void updateLibMediaSettings(SharedPreferences pref) {
        LibVLC instance = LibVLC.getExistingInstance();
        if (instance == null)
            return;
    ...
    public static String readAsset(String assetName, String defaultS) {
        try {
            InputStream is = MEDIAApplication.getAppResources().getAssets().open(assetName);
    ...
    public static String getValue(String string, int defaultId)
    {
        return (string != null && string.length() > 0) ?
                string : MEDIAApplication.getAppContext().getString(defaultId);
    }

    public static int convertPxToDp(int px) {
        WindowManager wm = (WindowManager) MEDIAApplication.getAppContext().
    ...
    public static int convertDpToPx(int dp) {
        return Math.round(
                ...
                MEDIAApplication.getAppResources().getDisplayMetrics())
                         );
    }
...
//    }
    ...
    {
        return false;	//android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.JELLY_BEAN;
    }
...
//    }
    ...
    public static boolean isPhone(){
        TelephonyManager manager = (TelephonyManager) MEDIAApplication.getAppContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String[] getCustomDirectories() {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(MEDIAApplication.getAppContext());
